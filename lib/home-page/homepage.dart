                            ...
                            child: Padding(
                              ...
                              child: TextField(
                                ...
                                onChanged: (text) {
                                  ...
                                  if (_textEditingController.value.text.startsWith(' ', 0) ||
                                ...
                                decoration: InputDecoration(
                                  suffixIcon: IconButton(
                                    color: FocusManager.instance.primaryFocus!.offset.dy > 0 ? Colors.red : null,
                                    onPressed: () {
                                      setState(() {
                                        readyToWrite = false;
                                        listaCidades.clear();
                                        _textEditingController.clear();
                                        FocusManager.instance.primaryFocus!.offset.dy > 0
                                  ...
                                  helperText: _textEditingController.value.composing.isValid == false
                                      ? 'O nome do município deve conter apenas letras.'
                                      : null,
                        ...
                        children: [
                          ...
                          SfCartesianChart(
                            ...
                            series: [
                              ...
                              LineSeries<PlotRiscoEstiagem, String>(
                                ...
                                yAxisName: '(%) Estiagem',
                                markerSettings:
                                    const MarkerSettings(height: 5, width: 5, isVisible: false, color: Colors.white),
                                dataSource: <PlotRiscoEstiagem>[
                                  ...
                                  PlotRiscoEstiagem('11-20/mar', _riscoEstiagem[7]),
                          ...
                          Column(
                            children: <Widget>[
                              Row(
                                children: <Widget>[
                                  Icon(Icons.circle, color: const Color.fromRGBO(26, 112, 23, 1), size: size),
                                  Text('Baixo Risco: 0% à 20%', style: TextStyle(fontSize: fontSize))
                                ],
                              ),
                              Row(
                                children: <Widget>[
                                  Icon(Icons.circle, color: Colors.blue, size: size),
                                  Text('Médio Risco: 20% à 40%', style: TextStyle(fontSize: fontSize)),
                                ],
                              ),
                              Row(
                                children: <Widget>[
                                  Icon(Icons.circle, color: const Color.fromRGBO(229, 11, 10, 1), size: size),
                                  Text('Alto Risco: 40% à 100%', style: TextStyle(fontSize: fontSize))
                                ],
                              ),
                            ],
                          ),
                                    ...
                                    : CityNames.cityNames[estacao]![2] == 'Norte Pioneiro Paranaense'
                                        ...
                                        : CityNames.cityNames[estacao]![2] == 'Oeste Paranaense'
                                            ...
                                            : CityNames.cityNames[estacao]![2] == 'Sudeste Paranaense'
                                                ? _mediaEstiagem.addAll(ListaCidadesBrasil.sudesteParanaense)
                                                : CityNames.cityNames[estacao]![2] == 'Sudoeste Paranaense'
                                                    ? _mediaEstiagem.addAll(ListaCidadesBrasil.sudoesteParanaense)
                                                    : _mediaEstiagem.clear();
          },
        );
      }
...
class PlotMinimo {
  PlotMinimo(this.decendio, this.risco);
  final String decendio;
  final int risco;
}

class PlotMedio {
  PlotMedio(this.decendio, this.risco);
  final String decendio;
  final int risco;
}

class PlotAlto {
  PlotAlto(this.decendio, this.risco);
  final String decendio;
  final int risco;
}
