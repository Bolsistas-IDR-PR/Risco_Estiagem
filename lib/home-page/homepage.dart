...
class _HomePageState extends State<HomePage> {
  ...
  void _setMap(int codEstacao) {
    setState(() {
      _markerLocation = LatLng(CityNames.cityNames[codEstacao]![3],
          CityNames.cityNames[codEstacao]![4]);
                            ...
                            Expanded(
                              ...
                              child: Padding(
                                ...
                                child: TextField(
                                  onTap: () {
                                    listaCidades.addAll(
                                        ListaCidadesBrasil.listaCidadesBrasil);
                                    setState(
                                      () {
                                        readyToWrite = true;
                                      },
                        ...
                        child: Column(
                          children: [
                            SfCartesianChart(
                              ...
                              title:
                                  ChartTitle(text: ' Estiagem (%) - $_cidade'),
                              legend: Legend(
                              ...
                              series: <LineSeries<PlotRiscoEstiagem, String>>[
                                LineSeries<PlotRiscoEstiagem, String>(
                                  ...
                                  dataSource: <PlotRiscoEstiagem>[
                                    PlotRiscoEstiagem(
                                        'jan-1', _riscoEstiagem[0]),
                                    PlotRiscoEstiagem(
                                        'jan-2', _riscoEstiagem[1]),
                                    PlotRiscoEstiagem(
                                        'jan-3', _riscoEstiagem[2]),
                                    PlotRiscoEstiagem(
                                        'fev-1', _riscoEstiagem[3]),
                                    PlotRiscoEstiagem(
                                        'fev-2', _riscoEstiagem[4]),
                                    PlotRiscoEstiagem(
                                        'fev-3', _riscoEstiagem[5]),
                                    PlotRiscoEstiagem(
                                        'mar-1', _riscoEstiagem[6]),
                                    PlotRiscoEstiagem(
                                        'mar-2', _riscoEstiagem[7]),
                                    PlotRiscoEstiagem(
                                        'mar-3', _riscoEstiagem[8]),
                                    PlotRiscoEstiagem(
                                        'abr-1', _riscoEstiagem[9]),
                                    PlotRiscoEstiagem(
                                        'abr-2', _riscoEstiagem[10]),
                                    PlotRiscoEstiagem(
                                        'abr-3', _riscoEstiagem[11]),
                                    PlotRiscoEstiagem(
                                        'mai-1', _riscoEstiagem[12]),
                                    PlotRiscoEstiagem(
                                        'mai-2', _riscoEstiagem[13]),
                                    PlotRiscoEstiagem(
                                        'mai-3', _riscoEstiagem[14]),
                                    PlotRiscoEstiagem(
                                        'jun-1', _riscoEstiagem[15]),
                                    PlotRiscoEstiagem(
                                        'jun-2', _riscoEstiagem[16]),
                                    PlotRiscoEstiagem(
                                        'jun-3', _riscoEstiagem[17]),
                                    PlotRiscoEstiagem(
                                        'jul-1', _riscoEstiagem[18]),
                                    PlotRiscoEstiagem(
                                        'jul-2', _riscoEstiagem[19]),
                                    PlotRiscoEstiagem(
                                        'jul-3', _riscoEstiagem[20]),
                                    PlotRiscoEstiagem(
                                        'ago-1', _riscoEstiagem[21]),
                                    PlotRiscoEstiagem(
                                        'ago-2', _riscoEstiagem[22]),
                                    PlotRiscoEstiagem(
                                        'ago-3', _riscoEstiagem[23]),
                                    PlotRiscoEstiagem(
                                        'set-1', _riscoEstiagem[24]),
                                    PlotRiscoEstiagem(
                                        'set-2', _riscoEstiagem[25]),
                                    PlotRiscoEstiagem(
                                        'set-3', _riscoEstiagem[26]),
                                    PlotRiscoEstiagem(
                                        'out-1', _riscoEstiagem[27]),
                                    PlotRiscoEstiagem(
                                        'out-2', _riscoEstiagem[28]),
                                    PlotRiscoEstiagem(
                                        'out-3', _riscoEstiagem[29]),
                                    PlotRiscoEstiagem(
                                        'nov-1', _riscoEstiagem[30]),
                                    PlotRiscoEstiagem(
                                        'nov-2', _riscoEstiagem[31]),
                                    PlotRiscoEstiagem(
                                        'nov-3', _riscoEstiagem[32]),
                                    PlotRiscoEstiagem(
                                        'dez-1', _riscoEstiagem[33]),
                                    PlotRiscoEstiagem(
                                        'dez-2', _riscoEstiagem[34]),
                                    PlotRiscoEstiagem(
                                        'dez-3', _riscoEstiagem[35]),
                                  ],
                                  xValueMapper: (PlotRiscoEstiagem sales, _) =>
                                      sales.decendio,
                                  yValueMapper: (PlotRiscoEstiagem sales, _) =>
                                      sales.risco,
                                ),
                              ],
                            ),
                            ...
                            SfCartesianChart(
                                ...
                                plotBands: <PlotBand>[
                                  ...
                                  PlotBand(
                                    ...
                                    textStyle: const TextStyle(
                                        color: Colors.black, fontSize: 13),
                                    color:
                                        const Color.fromRGBO(254, 213, 2, 0.2),
                                    opacity: 0.5,
                                  ),
                                  PlotBand(
                                    horizontalTextAlignment: TextAnchor.middle,
                                  ...
                                  PlotBand(
                                    ...
                                    textStyle: const TextStyle(
                                        color: Colors.black, fontSize: 13),
                                    color:
                                        const Color.fromRGBO(140, 198, 62, 0.2),
                                    opacity: 0.5,
                                  ),
                                  PlotBand(
                                    isVisible: true,
                                    ...
                                    textStyle: const TextStyle(
                                        color: Colors.black, fontSize: 13),
                                    color:
                                        const Color.fromRGBO(217, 112, 1, 0.2),
                                    opacity: 0.5,
                                  ),
                                ],
                              ),
                              ...
                              title: ChartTitle(
                                  text:
                                      'Média de Estiagem na Região: $_mesorregiao'),
                              legend: Legend(
                                position: LegendPosition.bottom,
                                isResponsive: true,
                              ),
                              series: <
                                ...
                                LineSeries<PlotMediaMesorregiao, String>(
                                  ...
                                  dataSource: <PlotMediaMesorregiao>[
                                    PlotMediaMesorregiao(
                                        '1-10/jan', _mediaEstiagem[0]),
                                    PlotMediaMesorregiao(
                                        '11-20/jan', _mediaEstiagem[1]),
                                    PlotMediaMesorregiao(
                                        '21-31/jan', _mediaEstiagem[2]),
                                    PlotMediaMesorregiao(
                                        '1-10/fev', _mediaEstiagem[3]),
                                    PlotMediaMesorregiao(
                                        '11-20/fev', _mediaEstiagem[4]),
                                    PlotMediaMesorregiao(
                                        '21-29fev', _mediaEstiagem[5]),
                                    PlotMediaMesorregiao(
                                        '1-10/mar', _mediaEstiagem[6]),
                                    PlotMediaMesorregiao(
                                        '11-20/mar', _mediaEstiagem[7]),
                                    PlotMediaMesorregiao(
                                        '21-31/mar', _mediaEstiagem[8]),
                                    PlotMediaMesorregiao(
                                        '1-10/abr', _mediaEstiagem[9]),
                                    PlotMediaMesorregiao(
                                        '11-20/abr', _mediaEstiagem[10]),
                                    PlotMediaMesorregiao(
                                        '21-30/abr', _mediaEstiagem[11]),
                                    PlotMediaMesorregiao(
                                        '1-10/mai', _mediaEstiagem[12]),
                                    PlotMediaMesorregiao(
                                        '11-20/mai', _mediaEstiagem[13]),
                                    PlotMediaMesorregiao(
                                        '21-31/mai', _mediaEstiagem[14]),
                                    PlotMediaMesorregiao(
                                        '1-10/jun', _mediaEstiagem[15]),
                                    PlotMediaMesorregiao(
                                        '11-20/jun', _mediaEstiagem[16]),
                                    PlotMediaMesorregiao(
                                        '21-30/jun', _mediaEstiagem[17]),
                                    PlotMediaMesorregiao(
                                        '1-10/jul', _mediaEstiagem[18]),
                                    PlotMediaMesorregiao(
                                        '11-20/jul', _mediaEstiagem[19]),
                                    PlotMediaMesorregiao(
                                        '21-31/jul', _mediaEstiagem[20]),
                                    PlotMediaMesorregiao(
                                        '1-10/ago', _mediaEstiagem[21]),
                                    PlotMediaMesorregiao(
                                        '11-20/ago', _mediaEstiagem[22]),
                                    PlotMediaMesorregiao(
                                        '21-31/ago', _mediaEstiagem[23]),
                                    PlotMediaMesorregiao(
                                        '1-10/set', _mediaEstiagem[24]),
                                    PlotMediaMesorregiao(
                                        '11-20/set', _mediaEstiagem[25]),
                                    PlotMediaMesorregiao(
                                        '21-30/set', _mediaEstiagem[26]),
                                    PlotMediaMesorregiao(
                                        '1-10/out', _mediaEstiagem[27]),
                                    PlotMediaMesorregiao(
                                        '11-20/out', _mediaEstiagem[28]),
                                    PlotMediaMesorregiao(
                                        '21-31/out', _mediaEstiagem[29]),
                                    PlotMediaMesorregiao(
                                        '1-10/nov', _mediaEstiagem[30]),
                                    PlotMediaMesorregiao(
                                        '11-20/nov', _mediaEstiagem[31]),
                                    PlotMediaMesorregiao(
                                        '21-30/nov', _mediaEstiagem[32]),
                                    PlotMediaMesorregiao(
                                        '1-10/dez', _mediaEstiagem[33]),
                                    PlotMediaMesorregiao(
                                        '11-20/dez', _mediaEstiagem[34]),
                                    PlotMediaMesorregiao(
                                        '21-31/dez', _mediaEstiagem[35]),
                                  ],
                                  xValueMapper:
                                      (PlotMediaMesorregiao sales, _) =>
                                          sales.decendio,
                                  yValueMapper:
                                      (PlotMediaMesorregiao sales, _) =>
                                          sales.risco,
